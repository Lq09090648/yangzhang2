	...
	require(ggplot2)
	setwd("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/03.Diversity/BetaDiversity/PCA/order")
	data = read.table("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/03.Diversity/BetaDiversity/PCA/order/sample.o.relative.mat", head=T, na.strings=T,row.names=1,sep="\t")
...
######################### PCA plot without cluster ############################
    ...
    cairo_pdf(filename="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/03.Diversity/BetaDiversity/PCA/order/PCA.pdf",height=12,width=15)
    plot
dev.off()
