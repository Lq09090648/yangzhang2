    ...
    library(ggplot2)
    library(grid)
	community<-read.table("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/sample.f.relative.mat", head=T,na.strings=T, row.names=1,sep="\t")
...
#DCA
    ...
    write.csv(AL,file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/dca.csv")
        

#CCA    
    cca<-cca(community,envdata,scale=T)
    ccascore=scores(cca)
    write.csv(ccascore$sites,file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/cca.sample.csv")
    write.csv(cca$CCA$biplot,file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/cca.env.csv")
    write.csv(ccascore$species,file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/cca.sp.csv")
...
#CCA plot	
    ...
    cairo_pdf("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/CCA_sample_env.pdf",height=12,width=15)
    plot_CCA1
    png(filename="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/CCA_sample_env.png",res=600,height=5400,width=7200,type="cairo")
    plot_CCA1
    dev.off()	
	...
	plot_CCA2<-ggplot(plotdata, aes(CCAS1, CCAS2)) +
        ...
        theme(text=element_text(family="Arial",size=5))+geom_vline(aes(x=0,y=0),linetype="dotted")+
       	...
       	theme(panel.background = element_rect(fill='white', colour='black'), panel.grid=element_blank(), 
			...
			axis.title.x=element_text(colour='black', size=18),axis.title.y=element_text(colour='black', size=18),axis.text=element_text(colour='black',size=18),
			legend.title=element_blank(),legend.text=element_text(family="Arial", size=18),legend.key=element_blank())
        cairo_pdf("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/CCA_sample_env2.pdf",height=12,width=15)
        plot_CCA2
        png(filename="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/CCA_sample_env2.png",res=600,height=5400,width=7200,type="cairo")
        plot_CCA2
        dev.off()  
...
#Permutation test       
    ...
    write.csv(as.data.frame(env),file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/ccaenvfit.csv")

		
#RDA		
    rda<-rda(community,envdata,scale=T)
    rdascore<-scores(rda)
    write.csv(rdascore$sites,file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/rda.sample.csv")
    write.csv(rda$CCA$biplot,file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/rda.env.csv")
    write.csv(rdascore$species,file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/rda.sp.csv")
...
#RDA plot        
    plot_RDA1<-ggplot(plotdata, aes(RDAS1, RDAS2)) +
        ...
        theme(plot.title = element_text(size=22,colour = "black",face = "bold"))        
    cairo_pdf("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/RDA_sample_env.pdf",height=12,width=15)
    plot_RDA1
    png(filename="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/RDA_sample_env.png",res=600,height=5400,width=7200,type="cairo")
    plot_RDA1
    dev.off() 
    ...
    plot_RDA2<-ggplot(plotdata, aes(RDAS1, RDAS2)) +
        ...
        geom_hline(aes(x=0,y=0),linetype="dotted")+
       	theme(panel.background = element_rect(fill='white', colour='black'), panel.grid=element_blank(),
			...
			legend.title=element_blank(),legend.text=element_text(family="Arial", size=18),legend.key=element_blank())+
        theme(plot.title = element_text(size=22,colour = "black",face = "bold"))        
    cairo_pdf("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/RDA_sample_env2.pdf",height=12,width=15)
    plot_RDA2
    png(filename="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/RDA_sample_env2.png",res=600,height=5400,width=7200,type="cairo")
    plot_RDA2
    dev.off()         
...
#Permutation test 
    ...
    colnames(p)="Pr(>r)"
    env=cbind(envfit$vectors$arrows,r,p)
    write.csv(as.data.frame(env),file="/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/CCA/family/rdaenvfit.csv")  
