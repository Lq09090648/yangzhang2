library(psych);
alpha = read.table("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/output/05.Correlation/spearman/sample.g.relative35.tab.order_sample", head=T,sep='\t',row.names=1);
env =  read.table("/Mega/bioinfo/sci/Project/Mic/16sRNA/C10117100230/Project/project1/env_cor.order_sample", head=T,sep='\t',row.names=1);
